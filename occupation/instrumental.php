...
if (isset($_POST['submit'])) {
    ...
    extract($_POST);
    for ($a=0; $a < $c; $a++) { 
        $ins = "INSERT INTO fmcphy_occp.ADL VALUES(NULL,'$num','$rec','".$issue[$a]."','".$answer[$a]."','".$Comment[$a]."')";
        $res = $conn->query($ins);
        if ($res === TRUE) {
            $_SESSION['num'] = $num;
            $_SESSION['rec'] = $rec;
            ?>
            <meta http-equiv="refresh" content="0; URL=http:leisure.php">
            <?php
        }
    }
}
...
<div class="wrapper">
    ...
    <div id="content w3-light-grey">
        ...
        <div class="outer-w3-agile mt-3">
            <h4 class="tittle-w3-agileits mb-4">Instrumental ADL Status</h4>
                    ...
                    <div class="col-sm-12">
                      <form method="POST">
                          ...
                          <table class="table" border="1">
                              ...
                              <tr>
                                  <td>Care of others<input type="text" name="issue[]" value="Care of others" style="display: none;"></td>
                                  <td>
                                      <select name="answer[]" class="form-control">
                                          <option value="Dependent">Dependent</option>
                                          <option value="DeMax Asst">Max Asst</option>
                              ...
                              <tr>
                                  <td>Religious observance<input type="text" name="issue[]" value="Religious observance" style="display: none;"></td>
                                  <td>
                                      <select name="answer[]" class="form-control">
                                          <option value="Dependent">Dependent</option>
                                          <option value="DeMax Asst">Max Asst</option>

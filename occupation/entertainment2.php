...
if (isset($_POST['submit'])) {
    ...
    for($a = 0; $a < $c; $a++){
        $ins = "INSERT INTO fmcphy_occp.motivation VALUES(NULL,'$num','$rec', '".$question[$a]."', '".$answer[$a]."','Entertainment')";
        $res = $conn->query($ins);
    }
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:nxt.php">
        <?php
    }
}
?>
                  ...
                  <div class="row">
                      <form method="POST">
                        ...
                        <table class="table" border="1">
                            ...
                            <tr>
                                <td>Physical space<input type="text" name="question[]" value="Physical space" style="display: none;"></td>
                                <td>
                            ...
                            <tr>
                                <td>Physical Resources<input type="text" name="question[]" value="Physical Resources" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Social groups<input type="text" name="question[]" value="Social groups" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Operational Demands<input type="text" name="question[]" value="Operational Demands" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>

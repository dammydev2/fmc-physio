...
if (isset($_POST['submit'])) {
    ...
    for($a = 0; $a < $c; $a++){
        $ins = "INSERT INTO fmcphy_occp.motivation VALUES(NULL,'$num','$rec', '".$question[$a]."', '".$answer[$a]."','Comm')";
        $res = $conn->query($ins);
    }
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:process2.php">
        <?php
    }
}
?>
                  ...
                  <div class="row">
                      <form method="POST">
                        ...
                        <table class="table" border="1">
                            ...
                            <tr>
                                <td>Non verbal skills<input type="text" name="question[]" value="Non verbal skills" style="display: none;"></td>
                                <td>
                            ...
                            <tr>
                                <td>conversation<input type="text" name="question[]" value="conversation" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>vocal expression<input type="text" name="question[]" value="vocal expression" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Relationships<input type="text" name="question[]" value="Relationships" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>

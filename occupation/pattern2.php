...
if (isset($_POST['submit'])) {
    ...
    for($a = 0; $a < $c; $a++){
        $ins = "INSERT INTO fmcphy_occp.motivation VALUES(NULL,'$num','$rec', '".$question[$a]."', '".$answer[$a]."','Pattern')";
        $res = $conn->query($ins);
    }
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:comm2.php">
        <?php
    }
}
?>
                  ...
                  <div class="row">
                      <form method="POST">
                        ...
                        <table class="table" border="1">
                            ...
                            <tr>
                                <td>Routine<input type="text" name="question[]" value="Routine" style="display: none;"></td>
                                <td>
                            ...
                            <tr>
                                <td>Adaptability<input type="text" name="question[]" value="Adaptability" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Roles<input type="text" name="question[]" value="Roles" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Responsibility<input type="text" name="question[]" value="Responsibility" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>

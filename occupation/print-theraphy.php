...
<div class="wrapper">
    ...
    <div id="content w3-light-grey">
        ...
        <div class="outer-w3-agile mt-3">
            <h4 class="tittle-w3-agileits mb-4">Print Occupational Therapy Initial Assessment</h4>
                  ...
                  <form class="form-horizontal" method="POST" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                      <div class="control-group">
                        ...
                        <div class="controls">
                          ...
                          <?php 
                                    $query = ("SELECT * FROM patient WHERE num='$Physio' ORDER BY id DESC"); // Run your query

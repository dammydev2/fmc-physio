...
if (isset($_POST['submit'])) {
    ...
    for($a = 0; $a < $c; $a++){
        $ins = "INSERT INTO fmcphy_occp.motivation VALUES(NULL,'$num','$rec', '".$question[$a]."', '".$answer[$a]."','Process')";
        $res = $conn->query($ins);
    }
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:motor2.php">
        <?php
    }
}
?>
                  ...
                  <div class="row">
                      <form method="POST">
                        ...
                        <table class="table" border="1">
                            ...
                            <tr>
                                <td>Knowledge<input type="text" name="question[]" value="Knowledge" style="display: none;"></td>
                                <td>
                            ...
                            <tr>
                                <td>Timing<input type="text" name="question[]" value="Timing" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Organization<input type="text" name="question[]" value="Organization" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Problem solving<input type="text" name="question[]" value="Problem solving" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>

...
if (isset($_POST['submit'])) {
    ...
    for($a = 0; $a < $c; $a++){
        $ins = "INSERT INTO fmcphy_occp.motivation VALUES(NULL,'$num','$rec', '".$question[$a]."', '".$answer[$a]."','motivation')";
        $res = $conn->query($ins);
    }
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:pattern2.php">
        <?php
    }
}
?>
                  ...
                  <div class="row">
                      <form method="POST">
                        ...
                        <table class="table" border="1">
                            ...
                            <tr>
                                <td>Apprisal of ability<input type="text" name="question[]" value="Apprisal of ability" style="display: none;"></td>
                                <td>
                            ...
                            <tr>
                                <td>Expectation of success<input type="text" name="question[]" value="Expectation of success" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>interest<input type="text" name="question[]" value="interest" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>
                            ...
                            <tr>
                                <td>Choices<input type="text" name="question[]" value="Choices" style="display: none;"></td>
                                <td>
                                    <select class="form-control" name="answer[]">
                                        <option value="Facilitates occupational participation">Facilitates occupational participation</option>
                                        <option value="Allows occupational participation">Allows occupational participation</option>

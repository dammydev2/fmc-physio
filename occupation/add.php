...
if (isset($_POST['submit'])) {
    ...
    if ($res === TRUE) {
        ...
        $_SESSION['rec'] = $rec;
        ?>
        <meta http-equiv="refresh" content="0; URL=http:activity.php">
        <?php
    }
}
?>
...
<div class="wrapper">
    ...
    <div id="content w3-light-grey">
        ...
        <div class="outer-w3-agile mt-3">
            <h4 class="tittle-w3-agileits mb-4">Add Assesment</h4>
            ...
            <div class="col-sm-8">
              <form method="POST">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="Occupational"></textarea>
                </div>

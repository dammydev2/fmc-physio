...
if (isset($_POST['submit'])) {
    ...
    extract($_POST);
    for ($a=0; $a < $c; $a++) { 
        $ins = "INSERT INTO fmcphy_occp.activity VALUES(NULL,'$num','$rec','".$issue[$a]."','".$answer[$a]."','".$Comment[$a]."')";
        $res = $conn->query($ins);
        if ($res === TRUE) {
            $_SESSION['num'] = $num;
            $_SESSION['rec'] = $rec;
            ?>
            <meta http-equiv="refresh" content="0; URL=http:instrumental.php">
            <?php
        }
    }
}
...
<div class="wrapper">
    ...
    <div id="content w3-light-grey">
        ...
        <div class="outer-w3-agile mt-3">
            <h4 class="tittle-w3-agileits mb-4">Activities of Daily living(ADL Status)</h4>
                    ...
                    <div class="col-sm-12">
                      <form method="POST">
                          ...
                          <table class="table" border="1">
                              ...
                              <tr>
                                  <td>Toileting skills<input type="text" name="issue[]" value="Toileting skills" style="display: none;"></td>
                                  <td>
                                      <select name="answer[]" class="form-control">
                                          <option value="Dependent">Dependent</option>
                                          <option value="DeMax Asst">Max Asst</option>
                              ...
                              <tr>
                                  <td>Functional mobility<input type="text" name="issue[]" value="Functional mobility" style="display: none;"></td>
                                  <td>
                                      <select name="answer[]" class="form-control">
                                          <option value="Dependent">Dependent</option>
                                          <option value="DeMax Asst">Max Asst</option>
                              ...
                              <tr>
                                  <td>Personal device Care<input type="text" name="issue[]" value="Personal device Care" style="display: none;"></td>
                                  <td>
                                      <select name="answer[]" class="form-control">
                                          <option value="Dependent">Dependent</option>
                                          <option value="DeMax Asst">Max Asst</option>

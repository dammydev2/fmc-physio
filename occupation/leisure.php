...
if (isset($_POST['submit'])) {
    ...
    extract($_POST);
    for ($a=0; $a < $c; $a++) { 
        $ins = "INSERT INTO fmcphy_occp.leisure VALUES(NULL,'$num','$rec','".$issue[$a]."','".$answer[$a]."','".$Comment[$a]."')";
        $res = $conn->query($ins);
        if ($res === TRUE) {
            $_SESSION['num'] = $num;
            $_SESSION['rec'] = $rec;
            ?>
            <meta http-equiv="refresh" content="0; URL=http:client.php">
            <?php
        }
    }
}
...
<div class="wrapper">
    ...
    <div id="content w3-light-grey">
        ...
        <div class="outer-w3-agile mt-3">
            <h4 class="tittle-w3-agileits mb-4">Work/Leisure participation</h4>

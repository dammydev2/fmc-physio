...
<!--/sidebar-menu-->
<div class="sidebar-menu" style="background: green;">
	<header class="logo1">
	...
	<div class="menu">
		<ul id="menu" >
			...
			<li id="menu-academico" ><a href="add.php"><i class="fa fa-envelope nav_icon"></i><span>Add User</span><div class="clearfix"></div></a></li>
			<li><a href="index.php"><i class="fa fa-picture-o" aria-hidden="true"></i><span>View User</span><div class="clearfix"></div></a></li>

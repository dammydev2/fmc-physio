...
if(!empty($_POST["submit"])) {
	if ($_POST["Password1"] != $_POST["Password2"]) {
		...
		$sel = "SELECT * FROM login WHERE user='".$_POST["Username"]."'";
		$res = $gen->query($sel);
		if ($res->num_rows > 0) {
			echo "<script>
			...
			echo  "<span style='color: #fff'>".$query = "INSERT INTO login(name, user, pass,type) VALUES('".$_POST["name"]."','".$_POST["Username"]."','".$_POST["Password2"]."','".$_POST["type"]."')";
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<div class="four-grids" style="height: 500px;">
					<div class=" w3-sand" style="background: #fff; padding: 5px; min-height: 500px;">
						<!--::::::CRUD STARTS:::::::::::::-->
						<p>&nbsp;</p>
						<h2><b>ADD USER</b></h2>
						...
						<form name="frmToy" method="POST" class="col-sm-5" action="" id="frmToy" onClick="return validate();">
							...
							<div class="form-group">
								...
								<span id="name-info" class="info"></span><br/>
								<input type="text" name="Username" id="name" class="demoInputBox form-control">
							</div>
							<div class="form-group">
								<label>Password</label>
								<span id="code-info" class="info"></span><br/>
								<input type="Password" minlength="8" name="Password1" id="code" class="demoInputBox form-control">
							</div>
							<div class="form-group">
								<label>Re-enter Password</label>
								<span id="code-info2" class="info2"></span><br/>
								<input type="Password" minlength="8" required="" name="Password2" id="code2" class="demoInputBox form-control">
							</div>
							<div class="form-group">

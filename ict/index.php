...
require_once("perpage.php");	
	...
	$sql = "SELECT * FROM login " . $queryCondition;
	$href = 'index.php';					
	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Home</a> <i class="fa fa-angle-right"></i>ICT</li>
				</ol>
				<!--four-grids here-->
				<div class="four-grids" style="height: 500px;">
					<div class=" w3-sand" style="background: #fff; padding: 5px;">
						...
						<div style="text-align:right;margin:20px 0px 10px;">
							<a id="btnAddAction" href="add.php" class="btn btn-primary">Add New User</a>
						</div>
						<div id="toys-grid">      
							<form name="frmSearch" method="post" action="index.php">
								<div class="search-box">
									<p><input type="text" placeholder="Name" name="search[name]" class="demoInputBox" value="<?php echo $name; ?>"	/><input type="text" placeholder="category" name="search[code]" class="demoInputBox" value="<?php echo $code; ?>"	/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="go" class="btnSearch btn btn-success" value="Search">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" class="btnSearch btn-danger btn" value="Reset" onclick="window.location='index.php'"></p>
								</div>
								...
								<table cellpadding="10" cellspacing="1" class="table table-bordered">
									<thead>
										<tr>
											...
											<th style="background: black; color: white;"><strong>Username</strong></th>  
											<th style="background: black; color: white;"><strong>Password</strong></th>
											<th style="background: black; color: white;"><strong>category</strong></th>
										</tr>
									</thead>
									<tbody>
										<?php
											...
											foreach($result as $k=>$v) {
												if(is_numeric($k)) {
													...
													<tr style="color: #000;">
														...
														<td><?php echo $result[$k]["user"]; ?></td>
														<td><?php echo $result[$k]["pass"]; ?></td>
														<td><?php echo $result[$k]["type"]; ?></td>
														<td>

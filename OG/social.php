...
if (isset($_POST['submit'])) {	
	extract($_POST);
	$ins = "INSERT INTO fmcphy_OG.social VALUES(NULL,'$num','$rec','$Spouse','$age','$occupation','$P_occupation','$apartment','$smoke','$drink','$physio','$Related')";
	$res = $conn->query($ins);
	if ($res === TRUE) {
				...
				<div class="content-bottom">
					<div class="col-md-12 post-top">
						...
						<div class="col-md-12" style="background-color: white;">
							<h3 class="text-center">SOCIAL HISTORY/INTEREST/ LIVING ENVIRONMENT</h3>
							<p>&nbsp;</p>
							...
							<div class="col-md-4">
								<form method="POST">
									...
									<div class="form-group">
										...
										<input type="text" name="P_occupation" class="form-control">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<label>Yes <input type="radio" name="smoke" value="Yes"></label>&nbsp;&nbsp;&nbsp;&nbsp;
										<label>No <input type="radio" name="smoke" value="No"></label>
									</div>
									<div class="form-group">
										<label>Do you drink?</label>&nbsp;&nbsp;
										<label>Yes <input type="radio" name="drink" value="Yes"></label>&nbsp;&nbsp;&nbsp;&nbsp;
										<label>No <input type="radio" name="drink" value="No"></label>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="Related"></textarea>
									</div>

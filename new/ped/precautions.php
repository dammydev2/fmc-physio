...
if (isset($_POST['submit'])) {
	...
	for($a = 0; $a < $c; $a++)
	{ 
		$ins = "INSERT INTO fmcphy_ped.precaution VALUES(NULL,'$num','$rec','$physio','$related','".$issue[$a]."','".$answer[$a]."','".$comment[$a]."')";
		$res = $conn->query($ins);
		if ($res === TRUE) {
			?>
			<meta http-equiv="refresh" content="0; URL=http:medication.php">
			<?php
		}
	}
}

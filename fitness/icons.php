						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="content all-icons">
									<div class="row">
										<form class="w3-container w3-light-grey w3-border w3-round" />
										<div class="col-md-4" >
										...
										<div class="col-md-4" >
											...
											<input class="w3-input w3-border w3-round" type="num" required="" >
										</div>
										<div class="col-md-4" >
										...
										<div class="col-md-12" ><h3 style="text-align: center;" >MEDICAL HISTORY</h3></div>
										<div class="col-md-12" >
										...
										<br/>
										<p>&nbsp;</p>
										<button class="w3-btn w3-blue w3-round">Register</button>
										<p>&nbsp;</p>
									</form>
								</div>

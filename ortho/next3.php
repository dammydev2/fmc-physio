...
if (isset($_POST['submit'])) {
  ...
  for($a = 0; $a < $c; $a++)
  { 
    $ins = "INSERT INTO fmcphy_ortho.range_1 VALUES(NULL,'$num','$rec','".$issue[$a]."','".$cAROM[$a]."','".$cPROM[$a]."','".$cend[$a]."','".$tAROM[$a]."','".$tPROM[$a]."','".$tend[$a]."','$Comments')";
    $res = $conn->query($ins);
  }
  if ($res === TRUE) {
   ?>
    <meta http-equiv="refresh" content="0; URL=http:next4.php">
    <?php
  }
  else{
    echo $conn->error;
                ...
                <div class="panel panel-primary  w3-card w3-sand">
                  ...
                  <div class="panel-body">
                    <table class="table" border="1">
                      ...
                      <tr>
                        <td><input type="text" name="issue[]" value="L Side Bend" readonly></td>
                        <td><input type="text" name="cAROM[]"></td>
                        <td><input type="text" name="cPROM[]"></td>
                        <td><input type="text" name="cend[]"></td>
                        <td><input type="text" name="tAROM[]"></td>
                      ...
                      <tr>
                        <td><input type="text" name="issue[]" value="R Side Bend" readonly></td>
                        <td><input type="text" name="cAROM[]"></td>
                        <td><input type="text" name="cPROM[]"></td>
                        <td><input type="text" name="cend[]"></td>
                        <td><input type="text" name="tAROM[]"></td>
                      ...
                      <tr>
                        <td><input type="text" name="issue[]" value="L Rotation" readonly></td>
                        <td><input type="text" name="cAROM[]"></td>
                        <td><input type="text" name="cPROM[]"></td>
                        <td><input type="text" name="cend[]"></td>
                        <td><input type="text" name="tAROM[]"></td>
                      ...
                      <tr>
                        <td><input type="text" name="issue[]" value="R Rotation" readonly></td>
                        <td><input type="text" name="cAROM[]"></td>
                        <td><input type="text" name="cPROM[]"></td>
                        <td><input type="text" name="cend[]"></td>
                        <td><input type="text" name="tAROM[]"></td>
